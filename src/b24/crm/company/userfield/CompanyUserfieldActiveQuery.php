...
class CompanyUserfieldActiveQuery extends ActiveQuery
{
    protected $listMethodName = 'crm.company.userfield.list';

    protected $oneMethodName = 'crm.company.userfield.get';
