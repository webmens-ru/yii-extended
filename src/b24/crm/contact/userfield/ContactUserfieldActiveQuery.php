...
class ContactUserfieldActiveQuery extends ActiveQuery
{
    protected $listMethodName = 'crm.contact.userfield.list';

    protected $oneMethodName = 'crm.contact.userfield.get';
